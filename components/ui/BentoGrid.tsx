...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 gap-8 max-w-7xl lg:gap-8 mx-auto ",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
 ...
 spareImg,
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("amar.mehdi140@gmail.com");
    setcopied(true);
  ...
  useEffect(() => {
    if (copied) {
      ...
      const resetConfettiAnimation = setTimeout(() => {
        setcopied(false); 
      }, 2500);

      
      return () => clearTimeout(resetConfettiAnimation);
    }
  }, [copied]);
